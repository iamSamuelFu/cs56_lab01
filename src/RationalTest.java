...
public class RationalTest {
   ...
   @Test
    ...
    @Test
    public void test_lcm_8_6(){
        assertEquals(24, Rational.lcm(8,6));
    }

    ////////////////////////////////////////////
    @Test
    public void test_r_6_1_lcm_r_m3_1(){
            int a = 6;
	    int b = -3;
	    int lc = Rational.lcm(6,-3);
            assertEquals(-6,lc);
    }

    @Test
    public void test_r_1_6_plus_r_1_m3(){
	    Rational r_1_6 = new Rational(1,6);
	    Rational r_1_m3 = new Rational(1,-3);
	    Rational r = r_1_6.plus(r_1_m3);
	    assertEquals("-1/6",r.toString());
    }

    @Test
    public void test_r_1_6_sum_r_1_m3(){
	    Rational r_1_6 = new Rational(1,6);
            Rational r_1_m3 = new Rational(1,-3);
            Rational r = Rational.sum(r_1_6,r_1_m3);
            assertEquals("-1/6",r.toString());
    }

    @Test
    public void test_r_3_7_minus_r_1_m3(){
            Rational r_1_m3 = new Rational(1,-3);
            Rational r = r_3_7.minus(r_1_m3);
            assertEquals("16/21",r.toString());
    }

    @Test
    public void test_r_3_7_difference_r_1_m3(){
            Rational r_1_m3 = new Rational(1,-3);
            Rational r = Rational.difference(r_3_7,r_1_m3);
            assertEquals("16/21",r.toString());
    }
    ...
    @Test
    public void test_r_3_7_dividedBy_r_1_m3(){
            Rational r_1_m3 = new Rational(1,-3);
            Rational r = r_3_7.dividedBy(r_1_m3);
            assertEquals("-9/7",r.toString());
    }

    @Test
    public void test_r_3_7_quotient_r_1_m3(){
            Rational r_1_m3 = new Rational(1,-3);
            Rational r = Rational.quotient(r_3_7,r_1_m3);
            assertEquals("-9/7",r.toString());
    }
    /////////////////////////////////////////////
}
